...
export function QuickActions() {
  return (
    <>
      ...
      `}</style>
      <div className="w-full flex flex-col sm:flex-row items-center justify-center p-1.5 bg-slate-200/80 backdrop-blur-md border border-slate-300 shadow-inner rounded-3xl sm:rounded-full gap-2 lg:max-w-max mx-auto">
        {actions.map((action) => {
        ...
        return (
          <Link key={action.title} to={action.href} className="block w-full sm:w-fit sm:flex-1">
            <div
              id={action.id}
              className="relative overflow-hidden w-full py-2.5 px-5 rounded-full bg-slate-50 border border-slate-200 shadow-[0_2px_5px_rgba(0,0,0,0.08),inset_0_-1px_2px_rgba(0,0,0,0.03),inset_0_1px_2px_rgba(255,255,255,1)] hover:shadow-[0_4px_12px_rgba(59,130,246,0.15),inset_0_-2px_4px_rgba(59,130,246,0.08),inset_0_2px_4px_rgba(255,255,255,1)] hover:bg-blue-50/80 hover:border-blue-200/60 hover:-translate-y-[1px] transition-all duration-300 group flex items-center justify-center gap-3 cursor-pointer"
            >
              ...
              <div className="relative z-10 flex shrink-0 items-center justify-center w-8 h-8 rounded-full bg-slate-100 border border-slate-200/60 shadow-[inset_0_2px_4px_rgba(255,255,255,0.7),0_1px_2px_rgba(0,0,0,0.05)] group-hover:bg-white group-hover:border-blue-100 group-hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_2px_6px_rgba(59,130,246,0.15)] transition-all duration-300">
                <IconComponent className="w-4 h-4 text-slate-500 group-hover:text-blue-500 drop-shadow-sm transition-colors duration-300" />
              </div>
              <p className="relative z-10 font-bold text-[13px] text-slate-600 whitespace-nowrap group-hover:text-blue-600 transition-colors duration-300">
                {action.title}
              </p>
            </div>
          </Link>
