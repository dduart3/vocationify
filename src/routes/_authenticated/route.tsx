...
function AuthenticatedLayout() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20">
      <AppSidebar />
      ...
      <div className="relative flex-1 w-full flex flex-col">
        ...
        <div className={`relative z-10 flex-1 flex flex-col ${isMobile ? 'pl-0 pt-20' : 'pl-0'}`}>
          <Outlet />
        </div>
      </div>
    </div>
